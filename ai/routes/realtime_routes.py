...
def _companion_narrator_prompt(language: str = "de") -> str:
    ...
    return (
        ...
        "was Alex hören will.\n"
        "  * **`[Operator-Anfrage an Agent]`** — Alex' getippte Frage. "
        "Nutze sie als KONTEXT für die Nachricht des Agenten "
        "('Auf deine Frage nach X antwortet <Name>: ...'). "
        "Verbalisiere die Frage selbst nur knapp und nur wenn es das "
        "Verständnis der Antwort braucht.\n"
        ...
        "siehst. Erfinde KEINE Aktivität nur weil du gefragt wirst.\n\n"
