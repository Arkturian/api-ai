...
def _companion_agent_transparent_prompt(language: str = "de") -> str:
    ...
    return (
        ...
        "Relay ist durch. **NIEMALS sagen 'ok, weitergegeben' / "
        "'an X gesendet' / 'übermittelt' o.ä.** — das bricht die "
        "1.-Person-Illusion und legt die Vermittler-Mechanik offen. "
        "Stattdessen: entweder kurz schweigen, bis die Agent-Antwort "
        "kommt, oder eine natürliche 1.-Person-Überbrückung wie "
        "'Moment, ich schau mir das an' / 'lass mich kurz "
        "nachdenken' — als ob DU selbst der Agent bist, der gerade "
        "die Frage prüft. Der Operator soll EIN Gesprächspartner "
        "erleben (dich = der fokussierte Agent), keinen Boten.\n"
