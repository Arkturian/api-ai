...
def _companion_narrator_prompt(language: str = "de") -> str:
    ...
    return (
        ...
        "  * `result=<y>` ist nur als wörtlich gelesener Status-String "
        "erlaubt ('3 Treffer', 'Datei aktualisiert', 'exit 0'), nie "
        "interpretiert oder ergänzt. Fehlt `result`: schweig dazu.\n\n"
