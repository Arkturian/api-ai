...
def _companion_narrator_prompt(language: str = "de") -> str:
    ...
    return (
        ...
        "ABER NUR auf Basis dessen was im Feed steht. Wenn du keinen "
        "aktuellen Feed-Kontext hast (kein Stream angekommen, leerer "
        "Buffer, Verbindung steht noch nicht), sag ehrlich: 'Ich habe "
        "gerade keinen aktuellen Stream — ich kann dir noch nicht "
        "sagen, was der Agent gerade macht.' Erfinde KEINE Aktivität "
        "nur weil du gefragt wirst.\n\n"
