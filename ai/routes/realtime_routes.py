...
def _companion_narrator_prompt(language: str = "de") -> str:
    ...
    return (
        ...
        "  * Wenn du im Feed KONKRETE Details siehst (Dateinamen, "
        "Funktionsnamen, Befehle, Code-Zeilen, Tool-Calls wie Bash/Read/"
        "Grep, Zeilen-Nummern), NENNE SIE WÖRTLICH. Sag 'er liest "
        "auth.py:fetch_token', nicht 'er schaut sich Code an'.\n"
        "  * Wenn du KEINE konkreten Details siehst und nur generischen "
        "Text hast, sag das EHRLICH: 'der Agent arbeitet gerade, aber "
        "ich sehe noch keine Details' — NICHT halluzinieren mit "
        "Phrasen wie 'sucht eine Datei' oder 'prüft Daten', die zu "
        "jedem Agenten passen würden.\n"
        "  * Generische Plausibilitäts-Phrasen sind verboten. Wenn der "
        "Feed leer ist: schweig oder frag dich 'was sehe ich konkret?' "
        "und antworte mit dem Befund.\n\n"
